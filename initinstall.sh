...
pacstrap -i /mnt base base-devel fuse linux-zen linux-zen-headers linux-firmware amd-ucode arch-install-scripts usbutils nano less git btrfs-progs exfat-utils ntfs-3g grub efibootmgr networkmanager wget
